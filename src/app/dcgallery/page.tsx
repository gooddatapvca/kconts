        ...
        <div className="rounded-xl border border-white/10 bg-zinc-950/40 p-4">
          ...
          <div className="flex flex-col gap-2">
            {drafts.map((d, idx) => (
              <div
                key={idx}
                className="grid grid-cols-1 gap-2 rounded-lg border border-white/10 bg-black/20 p-3 sm:grid-cols-3"
              >
                <div>
                  ...
                  <input
                    ...
                    placeholder="예: 6"
                    className="mt-1 w-full rounded-md border border-white/10 bg-black/40 px-3 py-2 text-sm text-zinc-50 outline-none placeholder:text-zinc-600 focus:border-white/20"
                  />
                </div>
                <div>
                  <label className="block text-xs font-medium text-zinc-300">
                ...
                <div className="sm:col-span-3 flex justify-end gap-2">
                  <button
                    ...
                    className="rounded-md border border-white/10 px-3 py-1.5 text-xs text-zinc-200 hover:bg-white/5 disabled:cursor-not-allowed disabled:opacity-60"
                  >
                    제거
                  </button>
                </div>
          ...
          <div className="mb-3 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-56 rounded-lg border border-white/10 bg-black/40 px-3 py-1.5 text-xs text-zinc-50 outline-none placeholder:text-zinc-600 focus:border-white/20"
              />
              <button
                onClick={refresh}
